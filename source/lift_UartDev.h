...
/* header definition ******************************************************** */
#ifndef _LIFT_UARTDEV_H_
#define _LIFT_UARTDEV_H_
...
#define LIFT_TIMEOUT					 UINT32_C(10000)
#define LIFT_DELAY_1000MS				UINT32_C(1000)
#define Lift_TX_BUFFER_SIZE           	(UINT32_C(1492))
#define Lift_RX_BUFFER_SIZE           	(UINT32_C(1492))
...
extern Lift_return_t Lift_DriverInit(void);
extern Lift_return_t send_AT_cmd_lift(uint8_t *cmdSend , uint8_t *cmdRecv,int timeoutMs);

extern Lift_return_t send_send_cmd_lift(uint8_t *cmdSend , uint8_t *cmdRecv,int timeoutMs);
extern Lift_return_t send_recv_cmd_lift(uint8_t *cmdSend , uint8_t *cmdRecv,int timeoutMs);

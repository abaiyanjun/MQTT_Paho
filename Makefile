...
export BCDS_APP_NAME = XDK_PAHO_DEMO
...
export BCDS_XDK_APP_SOURCE_FILES = \
	...
	$(BCDS_APP_SOURCE_DIR)/mqttSensor.c \
	$(BCDS_APP_SOURCE_DIR)/mqttPahoClient.c \
	$(BCDS_APP_SOURCE_DIR)/mqttInit.c \
	$(BCDS_APP_SOURCE_DIR)/mqttWifi.c \
	$(BCDS_APP_SOURCE_DIR)/mqttButton.c \
	...
	$(BCDS_APP_SOURCE_DIR)/cat1_API.c \
	$(BCDS_APP_SOURCE_DIR)/cat1_demo.c \
	$(BCDS_APP_SOURCE_DIR)/cat1_UartDev.c \
	$(BCDS_APP_SOURCE_DIR)/liftcheck.c \
	$(BCDS_APP_SOURCE_DIR)/lift_UartDev.c \
	$(BCDS_APP_SOURCE_DIR)/parson.c \
